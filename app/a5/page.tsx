...
export default function A5Page() {
  ...
  return (
    <div>
      ...
      />
      <Button
      onClick={() => {Reason1toast()}} color="primary">Reason #1</Button>
      <Button
      onClick={() => {Reason2toast()}} color="secondary">Reason #2</Button>
      <Button
      onClick={() => {Reason3toast()}} color="primary">Reason #3</Button>
      <Image 
      ...
      <div>
      <div className="my-3">
        <span className="text-xs">Celebrate your new understanding of Megamind!</span>
      </div>
...
<h2 className="text-center text-4xl font-bold">Extra things about Megamind!</h2>
<Accordion>
  <AccordionItem key={1} title="Was he always evil?">
    Kind of, but growing up Megamind was always an outcast. So it's not all his fault that he grew up to treat others poorly, just as he was treated as a child.
  </AccordionItem>
  <AccordionItem
    key={2}
    title="Where did Megamind grow up?">
    Megamind was being raised in a prison, further supporting his evil uprising that made him into the person he became.
  </AccordionItem>
</Accordion>
</section>
</div>
